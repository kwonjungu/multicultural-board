...
export const TILES: Tile[] = [
  { idx: 0, type: "start" },
  // Prices -10% / tolls +10% (balance-sim tune, 2026-04) — scripts/simulate-marble.mjs.
  { idx: 1, type: "city", country: "KR", color: "eastAsia", price: 216, tollBase: 53,
    landmark: { ko: "서울 남산타워", en: "Seoul N Tower", vi: "Tháp Namsan", zh: "首尔南山塔", ja: "ソウルNタワー" } },
  { idx: 2, type: "city", country: "JP", color: "eastAsia", price: 234, tollBase: 57,
    landmark: { ko: "도쿄 스카이트리", en: "Tokyo Skytree", vi: "Tháp Tokyo", zh: "东京晴空塔", ja: "東京スカイツリー" } },
  { idx: 3, type: "chance" },
  { idx: 4, type: "city", country: "CN", color: "eastAsia", price: 225, tollBase: 55,
    landmark: { ko: "만리장성", en: "Great Wall", vi: "Vạn Lý Trường Thành", zh: "长城", ja: "万里の長城" } },
  { idx: 5, type: "city", country: "MN", color: "eastAsia", price: 198, tollBase: 48,
